...
- Reminder (`api/reminder/send.js`) dan email tugas baru (dikirim dari `index.html` browser-side) sama-sama pakai kuota EmailJS gratis (±200/bulan) — kalau nanti reminder otomatis diaktifkan lagi, perhitungkan total konsumsi keduanya
